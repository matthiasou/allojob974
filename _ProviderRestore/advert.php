...
<div class="mainbody container-fluid">
    <div class="row">
        ...
        <div class="team-title col-lg-9 col-md-9 col-sm-12 col-xs-12">
                <h2 style="color: #9d426b; background-color: transparent;">Les Annonces</h2>
            </div>
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
              ...
              if(isset($_POST['proposez'])){
                ...
                // Mail candidature client 
                   ...
                   $message = file_get_contents('client_candidature/content.html'); 
                            ...
                            $message = str_replace('%prenomJob%', $_SESSION['prenom'], $message); 
                            $mail = new PHPMailer(); 
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <span class="pull-left">
                        <a href="#" class="btn btn-link" style="text-decoration:none;"><i class="glyphicon glyphicon-book" aria-hidden="true"></i> <?php echo $donnees['matiere']; ?> </a>
                        <a href="#" class="btn btn-link" style="text-decoration:none;"><i class="glyphicon glyphicon-equalizer" aria-hidden="true"></i> <?php echo $donnees['niveau']; ?> </a>
                        <a href="#" class="btn btn-link" style="text-decoration:none;"><i class="glyphicon glyphicon-pushpin" aria-hidden="true"></i> <?php echo $donnees['objectif']; ?></a>
...
<?php
      ...
      echo '<br><br><br><br><div style="color:#9d426b;Font-Weight: Bold;font-size: 25px;text-align:center;"> Vous devez être connecté et être un Job validé pour voir cette partie du site !</div><br><br><br><br><br><br><br><br><br><br><br><br><br>';
}
?>
