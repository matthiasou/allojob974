...
<?php
    ...
    if(isset($_POST['email'])){
        ...
        if($prenom == '')
            $errMsg .= 'Vous devez entrer un prenom<br><br>';

        if($telephone == '')
            $errMsg .= 'Vous devez entrer un numéro de GSM<br><br>';

        if($password != $password2)
            $errMsg .= 'Les deux mots de passe ne sont pas identiques <br><br>';
        ...
        if($errMsg == ''){
            ...
            if($results['id_utilisateur'] == null){
                $req = $pdo->prepare("INSERT INTO utilisateur (nom, prenom, email, telephone, password, status, type_utilisateur) VALUES (:nom, :prenom, :email, :telephone, :password, :status, :type_utilisateur)");
                $req->execute(array(
                                    "nom" => $_POST['nom'],
                                    "prenom" => $_POST['prenom'],
                                    "email" => $_POST['email'],
                   ...
                   $message = file_get_contents('client_inscr/content.html'); 
                            ...
                            $mail->Subject = "Inscription sur AlloJob974.fr";
                    ...
                    $errMsg .= 'Adresse email déja utilisée <br><br>';
                }
        }
    }                
?>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 wow fadeIn">
                            ...
                            <h1>Inscription/</h1>
                            <p>Devenez membres pour bénéficier de nos services</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="contact-us-container">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <form  method="post" class="form-signin">
                                    <h3 class="text-center">Nouveau Client<br/><br/></h3>
                                    <?php
            ...
            $( document ).ready(function() {
                swal({
                   ...
                   text: "Déposez une annonce gratuite, vous recevrez rapidement des candidatures de nos intervenants !",
                   type: "success",
            }, function(isConfirm) {
                 document.location.href="/sign_in.php"
                                    ...
                                    <div class="form-group">                
                                        <div class="input-group">
                                            ...
                                            <input name="nom" emailtype="text" class="form-control" placeholder="Nom" required="true" value="<?php echo $_POST['nom']; ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">                
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
                                            <input name="prenom" emailtype="text" class="form-control" placeholder="Prénom" required="true" value="<?php echo $_POST['prenom']; ?>" />
                                        </div>
                                    </div> 
                                    <div class="form-group">                
                                        <div class="input-group">
                                    ...
                                    <div class="form-group">                
                                        <div class="input-group">
                                            ...
                                            <input name="telephone" maxlength="10" emailtype="text" class="form-control" placeholder="Numéro de GSM" required="true" value="<?php echo $_POST['telephone']; ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
