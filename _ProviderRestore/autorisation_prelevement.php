   ...
   $message = file_get_contents('inscription/content.html'); 
            ...
            $( document ).ready(function() {
                swal({
                   ...
                   text: "Très rapidement, le intervenant vous appellera pour confirmer avec vous la date et l’heure du premier cours.",
                   type: "success",
            }, function(isConfirm) {
                 document.location.href="http://www.alloJob974.fr/index.php"
            });
            });
            </script>';
...
<div class="container">
  <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="box">
                <div class="box-icon">
                    <span class="fa fa-4x fa-address-card-o"></span>
                </div>
                <div class="info">
                            ...
                            <div class="row ">
                                <div class="col-md-9 col-md-offset-1 shadow "  >
                                    ...
                                    <div class="form-group row">
                                        <h2 class="text-center" style="color: #9d426b;">Mandat</h2>
                                        <hr>
                                        <div class="form-group row">
