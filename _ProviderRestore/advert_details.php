...
<div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <span class="pull-left">
                      <i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i> <a style="font-size: 18px;" class="tag"><?php echo $annonces2['ville']; ?></a> <small><i class="glyphicon glyphicon-time" aria-hidden="true"></i> <?php echo $annonces2['minutes'];?> minutes du centre</small> 
                    </span>
                    <br><br><br>
                    <br>Commentaire:  <?php echo $annonces2['commentaire']; ?><br> Disponibilité:  <?php echo $annonces2['disponibilite']; ?> <hr>
                    <span class="pull-left">
                        <a href="#" class="btn btn-link" style="text-decoration:none;"><i class="glyphicon glyphicon-book" aria-hidden="true"></i> <?php echo $annonces2['matiere']; ?> </a>
                        <a href="#" class="btn btn-link" style="text-decoration:none;"><i class="glyphicon glyphicon-equalizer" aria-hidden="true"></i> <?php echo $annonces2['niveau']; ?> </a>
                        <a href="#" class="btn btn-link" style="text-decoration:none;"><i class="glyphicon glyphicon-pushpin" aria-hidden="true"></i> <?php echo $annonces2['objectif']; ?></a>
                        <a href="#" class="btn btn-link" style="text-decoration:none;"><i class="glyphicon glyphicon-time" aria-hidden="true"></i> <?php echo $annonces2['duree']; ?> </a>
                        <a href="#" class="btn btn-link" style="text-decoration:none;"><i class="glyphicon glyphicon-stats" aria-hidden="true"></i> <?php echo $annonces2['frequence']; ?> </a>
                    </span>
            ...
            <br>
            <button style="margin-left: 20px;" onclick="window.location.href='https://www.allojob974.fr/dashboard_intervenant.php'" class="pull-left btn">Retour</button>
