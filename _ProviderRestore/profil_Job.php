           ...
           <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <span class="pull-left">
                        ...
                        <i class="glyphicon glyphicon-book" aria-hidden="true"></i> <a Oclass="tag"><?php $texte=str_replace(array(","),' ',$resultat->matieres);  echo $texte; ?></a> 
                    </span>              
                </div>
            </div>
                ...
                <div class="panel-body">
                    ...
                    <span>
                        ...
                        <p>
                            ...
                            <br><br>
                            <button onclick="window.location.href='https://www.allojob974.fr/dashboard_client.php'" class="btn">Retour</button>
                            </body>
                        </p>
                    <div>
                    </div>
