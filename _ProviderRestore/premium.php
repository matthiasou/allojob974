    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 wow fadeIn">
                <img src="assets/img/premium.png" alt="Premium" style="width:4%;">
                <h1>L'offre premium</h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 wow fadeInLeftBig">
                        <h1><span class="violet">Allo Job 974</span> vous propose <span class="violet">l'offre premium!</span></h1>
                        <p>Vous n'avez pas le temps de vous occuper de la recherche d'un intervenant mais vous voulez rapidement un Service à la personne?</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 services-full-width-text wow fadeInLeft">
                        ...
                        <p>
                        Un responsable pédagogique effectuera pour vous la recherche et la sélection d'un intervenant correspondant au profil de votre enfant et à vos attentes.
                        Il réalise avec vous un bilan pédagogique par téléphone qui sera ensuite adressé au intervenant avant le premier cours.<br>
                        Il s'occupe pour vous de toute la partie administrative.<br>
                        <span class="violet"><strong>Vous n'avez rien à faire!</strong></span><br>
                        Si vous êtes intéressé, adressez nous un mail à l'adresse suivante et un responsable pédagogique prendra contact avec vous dans les 24 heures (jour ouvré):
                        <a href="mailto:alloJobpremium@gmail.com">alloJobpremium@gmail.com</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 call-to-action-text wow fadeInLeftBig">
                        <p>
                        La prestation est de <span class="violet">45€</span> TTC. Elle sera facturée seulement après que le premier cours ait eu lieu.
                        </p>
                    </div>
                </div>
            </div>
