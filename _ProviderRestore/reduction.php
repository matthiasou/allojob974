    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 wow fadeIn">
                <img src="assets/img/50.png" alt="Premium" style="width:6%;">
                <h1>Bénéficiez de 50% de réduction d'impôts</h1>
...
<!-- Presentation -->
        <div class="presentation-container">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 ">
                        <h1><span class="violet">Comment fonctionne la réduction (ou le crédit) d'impôts*?</span></h1>
                        <p>La loi actuelle vous permet de bénéficier d’une réduction (ou d’un crédit d’impôts)* de 50% sur l’intégralité des factures payées à <br><strong><span class="violet">Allo Job 974</span></strong>, agréée Service à la personne. Cela comprend toutes les heures de cours mais aussi les frais d’entrée dans la structure ainsi que l'offre PREMIUM si vous la demandez. Le plafond légal est fixé à 12 000 euros par an (soit une réduction maximale de 6000 euros par an). Ce plafond peut être porté à 15 000 euros (soit une réduction maximale de 7500 euros par an), à raison de 1500 euros supplémentaires pour chaque enfant à charge.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="presentation-container">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 ">
                        <h1><span class="violet">Je ne paie pas d'impôts sur le revenu, ai-je le droit à cet avantage?</span></h1>
                        <p><strong><span class="violet">Oui !</span></strong> Depuis le 1er janvier 2017, la réduction (ou le crédit d’impôts) est désormais généralisée à tout le monde ! Si vous ne payez pas d’impôt sur le revenu, l’avantage fiscal devient un remboursement par le trésor public de 50% des sommes versées à <strong><span class="violet">Allo Job 974</span></strong>. <a href="https://impots.dispofi.fr/impots-2017-generalisation-credit-impot-emploi-domicile">https://impots.dispofi.fr/impots-2017-generalisation-credit-impot-emploi-domicile</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <br><br><br>
       <small>*: Sous réserve de modifications de l'article 199 sexdecies</small>
