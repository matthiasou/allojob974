                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <select id="sel2" id="matieres" class="form-control"  name="matieres" required="true">
                              ...
                              <option data-option="GARDE D ENFANT" value="">--  Préciser votre service --</option>
                              <option value="SORTIE ECOLE" data-option="GARDE D ENFANT">SORTIE ECOLE</option>
                              <option value="SOIREE" data-option="GARDE D ENFANT">SOIRÉE</option>
                              <option value="MERCREDI, SAMEDI, VACANCES SCOLAIRES" data-option="GARDE D ENFANT">MERCREDI, SAMEDI, VACANCES SCOLAIRES</option>
                              <option value="IMPREVU / ENFANTS MALADES" data-option="GARDE D ENFANT">IMPREVU / ENFANTS MALADES</option>
                              ...
                              <option data-option="COURS" value="">--  Préciser votre service --</option>
                              <option value="MUSIQUE" data-option="COURS">MUSIQUE</option>
                              <option value="COURS D INFORMATIQUE" data-option="COURS">COURS D'INFORMATIQUE</option>
                              <option value="CHANT" data-option="COURS">CHANT</option>
                              <option value="DESSIN" data-option="COURS">DESSIN</option>
                              ...
                              <option data-option="ASSISTANCE ADMINISTRATIVE" value="">--  Préciser votre service --</option>
                              <option value="REDACTION DE TEXTE" data-option="ASSISTANCE ADMINISTRATIVE">RÉDACTION DE TEXTE</option>
                              <option value="TRADUCTION DE TEXTE" data-option="ASSISTANCE ADMINISTRATIVE">TRADUCTION DE TEXTE</option>
                              <option value="DECLARATION ADMINISTRATIVE" data-option="ASSISTANCE ADMINISTRATIVE">DÉCLARATION ADMINISTRATIVE</option>
                              <option value="AUTRES" data-option="ASSISTANCE ADMINISTRATIVE">AUTRES</option>
