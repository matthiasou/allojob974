        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="service wow fadeInDown">
                    ...
                    Une facture mensuelle détaillée vous est envoyée reposant sur la télégestion, une méthode de pointage fiable réalisé par les intervenants à l’arrivée et au départ de chaque intervenants.<br>
                    <br><br><br>
                </div>
            </div>
            <div class="col-sm-4">
        ...
        <div class="row">
            <div class="col-sm-12 call-to-action-text wow fadeInLeftBig">
                <p>
                    ...
                    <span class="violet">Avec l'offre premium, Allo Job 974 s'occupe de tout !</span>


                </p>
                <div class="call-to-action-button">
                    <a class="big-link-3" href="/premium.php">En savoir +</a>
                </div>
            </div>
        </div>
    </div>
