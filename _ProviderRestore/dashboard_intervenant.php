            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 wow fadeIn">
                        ...
                        <p>Ici vous pouvez voir vos prochains cours</p>
                    </div>
                </div>
            </div>
        </div>
...
while( $resultat = $notifications->fetch() )
{
    ...
    $sql5 = "UPDATE reponse_annonce SET non_lu_job = :non_lu_job WHERE id_reponse_annonce = :id_reponse_annonce";
...
<div class="container">
    ...
    <thead>
        ...
        <tr>
            <td class="text-center"><a href="javascript:{}" onclick="document.getElementById('<?php echo $i; ?>').submit();">Voir l'annonce</a></td>
