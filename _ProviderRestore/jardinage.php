        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="service wow fadeInUp">
                    <div class="service-icon"><img src="assets/img/tondeuse.png" alt="repassage" style="width:22%;"></div>
                    <h3>Tondre la pelouse</h3>
                    <br><br>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="service wow fadeInDown">
                    <div class="service-icon"><img src="assets/img/tailler.png" alt="tailler une haie" style="width:22%;"></div>
                    <h3>Tailler une haie</h3>
                    <br><br>
            ...
            <div class="col-sm-3">
                <div class="service wow fadeInUp">
                    <div class="service-icon"><img src="assets/img/debrousailleuse.png" alt="debrousailleuse" style="width:22%;"></div>
                    <h3>Débrousailler
                    </h3>
                    <br><br>
                </div>
            ...
            <div class="col-sm-3">
                <div class="service wow fadeInDown">
                    <div class="service-icon"><img src="assets/img/arbre.png" alt="arbre" style="width:22%;"></div>
                    <h3>Couper un arbre</h3>
                    <br><br>
                </div>
            </div>
            <div class="col-sm-3">
            ...
            <div class="col-sm-3">
                <div class="service wow fadeInDown">
                    <div class="service-icon"><img src="assets/img/plantation.png" alt="plantation" style="width:22%;"></div>
                    <h3>Plantation</h3>
                    <br><br>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="service wow fadeInDown">
                    <div class="service-icon"><img src="assets/img/leaf.png" alt="végétaux" style="width:22%;"></div>
                    <h3>Ramassage des végétaux</h3>
        ...
        <div class="row">
            <div class="col-sm-12 services-full-width-text wow fadeInLeft">
                ...
                <p style="font-size: x-small">
                    ...
                    <br>* L'article 82 de la loi n° 2016-1917 du 29 décembre 2016 de finances pour 2017 généralise le crédit d'impôt à l’ensemble des ménages pour les dépenses exposées à compter du 1 er janvier 2017.
                </p>
            </div>
        </div>
    </div>
