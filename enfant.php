    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 wow fadeIn">
                ...
                <h1>Garde d'enfants de plus de 3 ans / 11 € de l'heure*</h1>
            </div>
        </div>
    </div>
</div>
...
<div class="services-container">
    <div class="container">
        <div class="row">
            <div class="col-sm-3">
                <div class="service wow fadeInUp" style="height: 160px">
                    <div class="service-icon"><img src="assets/img/ecole.png" alt="ecole" style="width:22%;"></div>
            ...
            <div class="col-sm-3">
                <div class="service wow fadeInUp" style="height: 160px">
                    <div class="service-icon"><img src="assets/img/soiree.png" alt="soiree" style="width:22%;"></div>
                    <h3>Soirée</h3>
            ...
            <div class="col-sm-3">
                <div class="service wow fadeInUp" style="height: 160px">
                    <div class="service-icon"><img src="assets/img/calendar.png" alt="calendar" style="width:22%;"></div>
                    <h3>Mercredi, Samedi, Vacances scolaires
                    </h3>
                    <br><br><br>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="service wow fadeInUp" style="height: 160px">
                    <div class="service-icon"><img src="assets/img/enfants.png" alt="enfants" style="width:22%;"></div>
                    <h3>Imprévu / enfants malades</h3>
                    <br><br><br>
                </div>
            </div>
