        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="service wow fadeInUp">
                    ...
                    <h3>Ménage de votre maison</h3>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="service wow fadeInDown">
                    <div class="service-icon"><img src="assets/img/repassage.png" alt="repassage" style="width:22%;"></div>
                    <h3>Repassage</h3>
                </div>
            </div>
            <div class="col-sm-3">
