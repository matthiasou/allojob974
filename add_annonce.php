...
<?php
    ...
    $req->execute(array(
            "date" => $date, 
            "matiere" => $_POST['objectif'],
            "commentaire" => $_POST['commentaire'],
            "ville" => $ville,
            "minutes" => $_POST['minutes'],
            "objectif" => $_POST['matieres'],
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <select id="sel2" id="matieres" class="form-control"  name="matieres" required="true">
                                <option data-option="DEMENAGEMENT" value="">--  Préciser votre service --</option> 
                              <option value="DÉPLACER UN MEUBLE" data-option="DEMENAGEMENT">DEPLACER UN MEUBLE</option>
                              <option value="DEPLACER DE L ELECTROMENAGER" data-option="DEMENAGEMENT">DÉPLACER DE L'ÉLÉCTROMÉNAGER</option>
                              <option value="PORTER DES CARTONS" data-option="DEMENAGEMENT">PORTER DES CARTONS</option>
                              <option value="AUTRES" data-option="DEMENAGEMENT">AUTRES</option>
                              <option data-option="MENAGE" value="">--  Préciser votre service --</option> 
                              ...
                              <option data-option="REPASSAGE" value="">--  Préciser votre service --</option>
                              <option value="REPASSAGE" data-option="REPASSAGE">REPASSAGE</option> 
                              <option data-option="GARDE D ENFANTS" value="">--  Préciser votre service --</option>
                              <option value="SORTIE ECOLE" data-option="GARDE D ENFANTS">SORTIE ECOLE</option>
                              <option value="SOIREE" data-option="GARDE D ENFANTS">SOIRÉE</option>
                              <option value="MERCREDI, SAMEDI, VACANCES SCOLAIRES" data-option="GARDE D ENFANTS">MERCREDI, SAMEDI, VACANCES SCOLAIRES</option>
                              <option value="IMPREVU / ENFANTS MALADES" data-option="GARDE D ENFANTS">IMPREVU / ENFANTS MALADES</option>
                              <option data-option="JARDINAGE" value="">--  Préciser votre service --</option>
                              <option value="TONDRE LA PELOUSE" data-option="JARDINAGE">TONDRE LA PELOUSE</option>
                              <option value="TAILLER UNE HAIE" data-option="JARDINAGE">TAILLER UNE HAIE</option>
                              <option value="DEBROUSAILLER" data-option="JARDINAGE">DÉBROUSAILLER</option>
                              <option value="COUPER UN ARBRE" data-option="JARDINAGE">COUPER UN ARBRE</option>
                              <option value="PLANTATION" data-option="JARDINAGE">PLANTATION</option>
                              <option value="RAMASSAGE DES VEGETAUX" data-option="JARDINAGE">RAMASSAGE DES VÉGÉTAUX</option>
                              <option data-option="BRICOLAGE" value="">--  Préciser votre service --</option>
                              <option value="AMENAGEMENT" data-option="BRICOLAGE">AMÉNAGEMENT</option>
                              <option value="ELECTRICITE" data-option="BRICOLAGE">ÉLECTRICITÉ</option>
                              <option value="PLOMBERIE" data-option="BRICOLAGE">PLOMBERIE</option>
                              <option value="TRAVAUX" data-option="BRICOLAGE">TRAVAUX</option>
                              <option data-option="COURS DIVERS" value="">--  Préciser votre service --</option>
                              <option value="MUSIQUE" data-option="COURS DIVERS">MUSIQUE</option>
                              <option value="COURS D INFORMATIQUE" data-option="COURS DIVERS">COURS D'INFORMATIQUE</option>
                              <option value="CHANT" data-option="COURS DIVERS">CHANT</option>
                              <option value="DESSIN" data-option="COURS DIVERS">DESSIN</option>
                              <option data-option="INFORMATIQUE" value="">--  Préciser votre service --</option>
                              <option value="INSTALLER UNE IMPRIMANTE" data-option="INFORMATIQUE">INSTALLER UNE IMPRIMANTE</option>
                              <option value="NETTOYER UN ORDINATEUR" data-option="INFORMATIQUE">NETTOYER UN ORDINATEUR</option>
                              <option value="INSTALLATION DIVERSES" data-option="INFORMATIQUE">INSTALLATION DIVERSES</option>
                              <option value="AUTRES" data-option="INFORMATIQUE">AUTRES</option>
                              <option data-option="PLOMBERIE" value="">--  Préciser votre service --</option>
                              <option value="REPARATION" data-option="PLOMBERIE">RÉPARATION</option>
                              <option value="DEBOUCHER EVIER" data-option="PLOMBERIE">DÉBOUCHER ÉVIER</option>
                              <option value="CHANGER CHASSE D EAU" data-option="PLOMBERIE">CHANGER CHASSE D'EAU</option>
                              <option value="AUTRES" data-option="PLOMBERIE">AUTRES</option>
                              <option data-option="ADMINISTRATIF" value="">--  Préciser votre service --</option>
                              <option value="REDACTION DE TEXTE" data-option="ADMINISTRATIF">RÉDACTION DE TEXTE</option>
                              <option value="TRADUCTION DE TEXTE" data-option="ADMINISTRATIF">TRADUCTION DE TEXTE</option>
                              <option value="ADMINISTRATIF" data-option="ADMINISTRATIF">DÉCLARATION ADMINISTRATIVE</option>
                              <option value="AUTRES" data-option="ADMINISTRATIF">AUTRES</option>
                              <option data-option="AUTRE" value="">--  Préciser votre service --</option>
                              <option value="AUTRE" data-option="AUTRE">AUTRE</option>
                              <option data-option="ANIMAUX" value="">--  Préciser votre service --</option>
                              <option value="GARDER UN ANIMAL" data-option="ANIMAUX">GARDER UN ANIMAL</option>
                              <option value="PROMENER UN ANIMAL" data-option="ANIMAUX">PROMENER UN ANIMAL</option>
                              <option value="NOURRIR UN ANIMAL" data-option="ANIMAUX">NOURRIR UN ANIMAL</option>
                              <option value="AUTRES" data-option="ANIMAUX">AUTRES</option>
                              <option data-option="ELECTRICITE" value="">--  Préciser votre service --</option>
                              <option value="POSE DE LUMINAIRE" data-option="ELECTRICITE">POSE DE LUMINAIRE</option>
                              <option value="CHANGER UNE AMPOULE" data-option="ELECTRICITE">CHANGER UNE AMPOULE</option>
                              <option value="INSTALLER UNE PRISE ELECTRIQUE" data-option="ELECTRICITE">INSTALLER UNE PRISE ELECTRIQUE</option>
                              <option value="AUTRES" data-option="ELECTRICITE">AUTRES</option>
                            </select>
                        </div>    
                    </div>    
