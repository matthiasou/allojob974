...
<?php
$pdo = connect();
$annonces = $pdo->query("SELECT * FROM `annonce2` WHERE id_annonce2='".$_GET['id_annonce2']."'");
...
<div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <span class="pull-left">
                        <a href="#" class="btn btn-link" style="text-decoration:none;"><i class="glyphicon glyphicon-wrench" aria-hidden="true"></i> <?php echo $annonces2['matiere']; ?> </a>
                        <a href="#" class="btn btn-link" style="text-decoration:none;"><i class="glyphicon glyphicon-tasks" aria-hidden="true"></i> <?php echo $annonces2['objectif']; ?></a>
