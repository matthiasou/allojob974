...
if (isset($_POST['mail'])) {
   ...
   $message = file_get_contents('autorisation_mail/content.html'); 
            ...
            $( document ).ready(function() {
                swal({
                     title: "Mail envoyé",
                   text: "Vous allez recevoir un mail avec, en pièce jointe, une autorisation de prélèvement qu’il faut nous retourner par mail pour la mise en place de la prestation.",
                   type: "success",
            }, function(isConfirm) {
...
<div class="container">
  <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="box">
                <div class="box-icon">
                    <span class="far fa-thumbs-up fa-5x"></span>
                </div> 
                <div class="info">
                     <h3 style="line-height: 30px;" class="text-center">
                        Pour la mise en place rapide de l'intervention, remplissez tout de suite votre autorisation de prélèvement.<br/><br/></h3> 
                    <div style="text-align: center;" class="panel-body">

                        <form style="display: inline;"  method="post" class="form-signin">
                            <input style="background: #279FDE;color: #fff;" class="btn" type="submit" name="mail" value="Autorisation par mail" />
                        </form>
                            &nbsp ou &nbsp
                            ...
                            <input style="background: #279FDE;color: #fff;" class="btn" type="submit" name="en_ligne" value="Autorisation en ligne" />
                         </form>
                         <br><br><br>
                         <img width="20" src="/assets/img/info.png"> Si vous ne choisissez pas l'autorisation de prélèvement en ligne, vous allez la recevoir par mail avec une copie du mandat que vous venez de signer. C'est seulement après avoir reçu votre autorisation de prélèvement remplie et signée et accompagnée d'un rib que la prestation pourra avoir lieu.<br><br>
                    </div>
                </div>
            </div>
        </div>
