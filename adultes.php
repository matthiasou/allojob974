    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 services-full-width-text wow fadeInLeft">
                ...
                <p>
                    Il n’y a pas d’âge pour se perfectionner, se remettre à niveau ou apprendre ! Vous voulez apprendre <b>une langue étrangère</b>, travailler une matière en particulier, vous initier à <b>l’informatique</b>, ALLO Job  974 vous proposera un programme individualisé et adapté à votre demande et à vos besoins.
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 call-to-action-text wow fadeInLeftBig">
                <p>
                    Tous nos cours sont sur mesure et à la carte.
                    <span class="violet"> Nous nous adaptons à votre demande !</span>


                </p>
                <div class="call-to-action-button">
                    <a class="big-link-3" href="tel:+33692917777"><i class="fa fa-phone"></i>  appelez-nous</a>
                </div>
            </div>
        </div>
    </div>
